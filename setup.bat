...
helm install -n stackable minio oci://registry-1.docker.io/bitnamicharts/minio --set service.type=NodePort --set defaultBuckets="spark-logs/eventlogs;spark-jobs;datasets" --set auth.rootUser=admin --set auth.rootPassword=password --set tls.autoGenerated=true
